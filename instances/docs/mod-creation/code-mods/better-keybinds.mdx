...
:::note[Unity KeyCodes]
Find all valid Unity input KeyCodes [here](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/KeyCode.html).
:::

### Loading the keybindings

Call `SetupKeybindings<T>(Mod mod)` to load your keybindings, with the type parameter as the keybindings class you made, and the mod parameter being your mod's entrypoint inheriting from `ModLoader.Mod`.
